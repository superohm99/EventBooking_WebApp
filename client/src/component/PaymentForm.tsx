...
function PaymentForm(props: UserProps) {
    ...
    const getSecret = async () => {
        const response = await fetch(`http://localhost:3001/payment/${props.reserveId}/create-payment-intent`, {
            method: 'POST',
            headers: {
    ...
    const makePayment = async () => {
        ...
        try {
            ...
            if (paymentIntent.status === 'succeeded') {
                props.handlePayment({ status: true, paymentIntendId });
            }
